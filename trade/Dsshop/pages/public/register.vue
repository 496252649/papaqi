<template>
	<view class="container">
		...
		<view class="wrapper">
			<view class="left-top-sign">papaqi</view>
			<view class="welcome">
				注册
			</view>
			<view class="bg-white">
			...
			<view class="cu-modal" :class="modalName=='agreement'?'show':''">
				<view class="cu-dialog">
					...
					<view class="bg-white text-left padding text-sm">
						点击同意即表示您已阅读并同意
						<span class="text-blue" @tap="goNavigator(2)">《papaqi用户注册协议》</span>
						与
						<span class="text-blue" @tap="goNavigator(1)">《papaqi隐私政策》</span>
					</view>
		...
		data(){
			return {
				...
				nodes: [{
					...
					children: [{
						type: 'text',
						text: '在您注册成为papaqi用户的过程中，您需要完成我们的注册流程并通过点击同意的形式在线签署以下协议，'
					}],
					},{
					name: 'span',
					attrs: {
				...
				},
				{
					...
					children: [{
						type: 'text',
						text: '【请您注意】如果您不同意上述协议或其中任何条款约定，请您停止注册。您停止注册后将仅可以浏览我们的商品信息但无法享受我们的产品或服务。如您按照注册流程提示填写信息、阅读并点击同意上述协议且完成全部注册流程后，即表示您已充分阅读、理解并接受协议的全部内容；并表明您也同意paapqi可以依据以上的隐私政策内容来处理您的个人信息。'
					}],
				},
				{
					name: 'span',
					children: [{
						type: 'text',
						text: '如您对以上协议内容有任何疑问，您可随时与papaqi客服联系。'
					}],
				},
				],
				disabled: false,
